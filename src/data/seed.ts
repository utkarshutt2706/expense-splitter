...
const seedExpenses: Expense[] = [
    ...
    },
    {
        ...
        splitType: 'equal',
        splits: [
            { userId: CURRENT_USER_ID, amount: 240 },
            { userId: FRIEND_ABHINAV_ID, amount: 240 },
            { userId: FRIEND_KHEM_ID, amount: 240 },
            { userId: FRIEND_ABHAY_ID, amount: 240 },
        ],
    ...
    },
    {
        ...
        splitType: 'equal',
        splits: [
            { userId: CURRENT_USER_ID, amount: 113.8 },
            { userId: FRIEND_ABHAY_ID, amount: 113.8 },
            { userId: FRIEND_DIVANSHU_ID, amount: 113.8 },
            { userId: FRIEND_ABHINAV_ID, amount: 113.8 },
            { userId: FRIEND_KHEM_ID, amount: 113.8 },
        ],
    ...
    },
    {
        ...
        splitType: 'equal',
        splits: [
            { userId: CURRENT_USER_ID, amount: 329.49 },
            { userId: FRIEND_ABHAY_ID, amount: 329.49 },
            { userId: FRIEND_DIVANSHU_ID, amount: 329.49 },
            { userId: FRIEND_ABHINAV_ID, amount: 329.49 },
            { userId: FRIEND_KHEM_ID, amount: 329.49 },
        ],
    ...
    },
    {
        ...
        splitType: 'equal',
        splits: [
            { userId: FRIEND_KHEM_ID, amount: 431.23 },
            { userId: FRIEND_ABHINAV_ID, amount: 431.23 },
            { userId: CURRENT_USER_ID, amount: 431.22 },
        ],
        createdAt: '2026-07-24T10:00:00.000Z',
    },
    {
        id: 'expense-chicken-2',
        groupId: DAARU_PARTY_GROUP_ID,
        description: 'Chicken',
        amount: 460,
        paidByUserId: CURRENT_USER_ID,
        splitType: 'equal',
        splits: [
            { userId: FRIEND_ABHAY_ID, amount: 153.34 },
            { userId: FRIEND_ABHINAV_ID, amount: 153.33 },
            { userId: CURRENT_USER_ID, amount: 153.33 },
        ],
