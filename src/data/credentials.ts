...
const CREDENTIALS: Credential[] = [
    { username: 'utkarsh', password: 'changeme-utkarsh', userId: CURRENT_USER_ID },
    { username: 'abhay', password: 'changeme-abhay', userId: FRIEND_ABHAY_ID },
    { username: 'divanshu', password: 'changeme-divanshu', userId: FRIEND_DIVANSHU_ID },
    { username: 'abhinav', password: 'changeme-abhinav', userId: FRIEND_ABHINAV_ID },
    { username: 'khem', password: 'changeme-khem', userId: FRIEND_KHEM_ID },
];
